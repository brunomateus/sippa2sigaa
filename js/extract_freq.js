...
dados.push(JSON.parse(JSON.stringify({"nome": "Nome", "matricula": "Matrícula", "frequencia": "Frequência(%)", "faltas": "Faltas em Horas", "media": "Média Final", "af": "Avaliação Final", "mp": "Media sem final"})));
